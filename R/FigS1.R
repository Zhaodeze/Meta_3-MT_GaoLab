...
p1 <- ggplot(Cor_3MT, aes(x = Tissue_nmol, y = Plasma_nmol  )) +
  geom_point(color = "#cbbfa0", size = 2) +         geom_smooth(method = "lm", color = "#594436") +  stat_cor(method = "pearson") +
  labs(x = "Tissue_nmol", y = "Plasma_nmol", title = "Correlation Tissue and Plasma") +
  theme_classic() +                   
  theme(panel.grid = element_blank(),   
        axis.line = element_line(color = "black", linewidth = 0.8),  
        axis.ticks = element_line(color = "black", linewidth = 0.8), 
        axis.ticks.length = unit(0.25, "cm"),axis.text = element_text(color = "black", size = 12),
        axis.title = element_text(size = 13),plot.title = element_text(hjust = 0.5))

p2 <- ggplot(Cor_3MT, aes(x = Interstitial_fluid_nmol, y = Plasma_nmol  )) +
  geom_point(color = "#cbbfa0", size = 2) + geom_smooth(method = "lm", color = "#594436") +    stat_cor(method = "pearson") +
  labs(x = "Interstitial_fluid_nmol", y = "Plasma_nmol", title = "Correlation Interstitial fluid Tissue and Plasma") +
  theme_classic() +                   
  theme(panel.grid = element_blank(),   
    axis.line = element_line(color = "black", linewidth = 0.8),  
    axis.ticks = element_line(color = "black", linewidth = 0.8), 
